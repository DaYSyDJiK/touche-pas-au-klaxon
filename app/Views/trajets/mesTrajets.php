        ...
        <tbody>
            <?php foreach ($trajets as $trajet): ?>
                <tr>
                    ...
                    <td>
                        <a href="/touche-pas-au-klaxon/public/index.php/trajets/edit/<?= $trajet['id_trajet'] ?>" class="btn btn-sm btn-primary">Modifier</a>
                        <a href="/touche-pas-au-klaxon/public/index.php/trajets/delete/<?= $trajet['id_trajet'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce trajet ?');">Supprimer</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
